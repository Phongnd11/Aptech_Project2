...
public class PositionManager2 extends JInternalFrame {
...
//	}
	 ...
	 * Create the frame.
	 */
	public PositionManager2(CurrentUser cuser) {
		setBounds(0, 0, 1000, 475);
		
		btnAdd = new JButton("Add Position");
		
		btnUpdate = new JButton("Update Position");
		
		btnDelete = new JButton("Delete Position");
